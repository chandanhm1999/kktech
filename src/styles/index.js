const styles = {
  ...
  paddings: 'sm:p-12 xs:p-6 px-6 py-6',
  yPaddings: 'sm:py-12 xs:py-8 py-10',
  ...
  workSliderContainer: 'w-max-[1400px] w-[42vh] h-[65vh] lg:w-full md:w-full m-auto relative group',

  heroSlider: 'w-full m-auto relative group rounded-2xl bg-center bg-cover opacity-[0.7] duration-500',
  heroSliderContainer: 'w-full m-auto relative group',
};
